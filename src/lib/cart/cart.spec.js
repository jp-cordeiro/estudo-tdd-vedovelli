...
describe('Cart', () => {
  ...
  describe('special conditions', () => {
    ...
    it('receive two or more conditions and determine/apply the best discount.First case', () => {
      const condition1 = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('receive two or more conditions and determine/apply the best discount.Second case', () => {
      const condition1 = {
        percentage: 80,
        minimum: 2,
      };
